...
<div class="indexTopic_main">
	...
	<s:iterator value="infoListBirthControl" var="f" begin="0" end="0">
		<h3>
	...
	<p class="label">
		标签： <span>误区</span> | <span> 危险</span> | <span> 避孕</span>
	</p>
</div>
<div class="indexTopic_list">
	<ul>
		<s:iterator value="infoListBirthControl" var="f" begin="1" end="5">
			<li>
				...
				</div> <span class="stat" style="visibility: visible;"><s:property value="#f.click" />
			</span></li>
		</s:iterator>
	</ul>
</div>
