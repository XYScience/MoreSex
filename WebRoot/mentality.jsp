...
" target="_blank" title="<s:property value="#f.title"/>"><s:property value="#f.title" /> </a>
		...
		<div class="news">
			<div class="paging">
				<span> <a href="mentality/page_<s:property value='page>1?page-1:1'/>.html">上一页</a> </span> <span> <a href="mentality/page_<s:property value='page+1'/>.html">下一页</a> </span> <span class="paging2"><a href="mentality/page_<s:property value='page=1'/>.html"> 首页</a> </span>

				<s:iterator var="p" begin="1" end="5">
					<span><a href="mentality/page_<s:property value='#p'/>.html"><s:property value='#p' /> </a> </span>
				</s:iterator>

				<span><a href="mentality/page_<s:property value='page=infoSizeList.size/7'/>.html">尾页</a> </span>
