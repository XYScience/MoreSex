...
<div class="indexTopic_main">
	...
	<s:iterator value="infoListPhysiology" var="f" begin="0" end="0">
		<h3>
...
" title="#f.title" target="_blank"><s:property value="#f.title" /> </a>
	...
	<p class="label">
		标签： <span>干涩</span> | <span> 敏感</span> | <span> 兴奋</span>
	</p>
</div>
<div class="indexTopic_list">
	<ul>
		<s:iterator value="infoListPhysiology" var="f" begin="1" end="5">
			<li>
