		...
		<div class="news">
			<div class="paging">
				<span id="getNews_last" onmouseover="toGreen()" onmouseout="toRed()"> <a
					href="birthControlAction.action?page=<s:property value='page>1?page-1:1'/>">上一页</a>
				</span> 
				<span id="getNews_last1" onmouseover="toGreen1()" onmouseout="toRed1()"> <a
					href="birthControlAction.action?page=<s:property value='page+1'/>">下一页</a>
				</span> 
				<span class="paging2"><a
					href="birthControlAction.action?page=<s:property value='page=1'/>">
						首页</a> </span>

				<s:iterator var="p" begin="1" end="5">
					<span><a
						href="birthControlAction.action?page=<s:property value='#p'/>"><s:property
								value='#p' /> </a> </span>
				</s:iterator>

				<span id="getNews1" onmouseover="toGreen3()" onmouseout="toRed3()"><a
					href="birthControlAction.action?page=<s:property value='page=infoSizeList.size/7'/>">尾页</a>
