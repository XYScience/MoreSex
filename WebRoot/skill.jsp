...
" target="_blank" title="<s:property value="#f.title"/>"> <s:property value="#f.title" /> </a>
				...
				<div class="news_content">
					<p>
					<div class="cont" style="width: 420px; height:50px; text-overflow:ellipsis; overflow: hidden;">
		...
		<div class="news">
			<div class="paging">
				...
				<a href="skill/page_<s:property value='page>1?page-1:1'/>.html">上一页</a> </span>
				 
				<span id="getNews_last1" onmouseover="toGreen1()" onmouseout="toRed1()"> 
				<a href="skillAction.action?page=<s:property value='page+1'/>">下一页</a> </span> 
				...
				<span id="getNews1" onmouseover="toGreen3()" onmouseout="toRed3()"><a href="skill/page_<s:property value='page=infoSizeList.size/7'/>.html">尾页</a> </span>
